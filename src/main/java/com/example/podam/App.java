...
public class App 
{
	//Inicialización manual. *SUSCEPTIBLE A ERRORES* 
	...
	private static Vendedor[] vendedores = {
			...
			new Vendedor("La montaña", "lamontana@email.com", "3141513121"),
			new Vendedor("Ropa deportiva de Bogotá", "depobta@email.com", "3101112134"),
			};
    ...
    { 	
    	...
    	vendedores[1].ofrecer(new ArticuloUnitario("Pasamontañas niños", "Pasamontañas para niños con personajes de disney", "Accesorios", 6000));
    	...
    	vendedores[2].ofrecer(new ArticuloUnitario("Camisas de leñador", "Camisa roja con diseños de cuadros en color negro", "Camisas", 35000));
    	...
    	vendedores[3].ofrecer(new ArticuloUnitario("Canguro militar", "Canguro con diseño militar mediano", "Morrales", 25000));
    	vendedores[3].ofrecer(new ArticuloUnitario("Morral pequeño", "Morral lateral pequeño de tela azul resistente", "Morrales", 33000));
    	vendedores[3].ofrecer(new ArticuloUnitario("Billetera de tela", "Billetera de color negro hecha en tela con múltiples compartimientos", "Accesorios", 20000));
    	...
    	vendedores[4].ofrecer(new ArticuloUnitario("Medias de futbol", "Medias largas de color blanco para jugar fútbol", "Accesorios", 8000));
